...
export class HistoryComponent {
  ...
  expenses: { month: string, expenseAmount: number }[] = [
    { month: 'January', expenseAmount: 800 },
    { month: 'February', expenseAmount: 1000 },
    { month: 'March', expenseAmount: 1000 },
  ];
  monthSelected: boolean = false;
  januaryExpense: any[] = [
    { expenseType: 'Internet', expenseAmount: 1000 },
    { expenseType: 'Groceries', expenseAmount: 500 },
  ];
  februaryExpense: any[] = [
    { expenseType: 'Transportations', expenseAmount: 200 },
    { expenseType: 'Groceries', expenseAmount: 400 }
  ];
  marchExpense: any[] = [
    { expenseType: 'Internet', expenseAmount: 1100 },
