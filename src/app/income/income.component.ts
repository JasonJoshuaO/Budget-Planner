...
export class IncomeComponent {
  ...
  selectedMonth: any;
  januaryIncomes: any[] = [
    { source: 'Salary', amount: 5000, investments: 'P.E.R.A' },
    { source: 'Freelancing', amount: 1000, investments: 'Stocks' },
  ];
  februaryIncomes: any[] = [
    { source: 'Salary', amount: 5500, investments: 'P.E.R.A' },
    { source: 'Rental Income', amount: 700, investments: 'NFTs' },
  ];
  marchIncomes: any[] = [
    { source: 'Salary', amount: 5200, investments: 'P.E.R.A' },
    { source: 'Freelancing', amount: 1200, investments: 'Stocks' },
    { source: 'Rental Income', amount: 600, investments: 'NFTs' },
  ];
